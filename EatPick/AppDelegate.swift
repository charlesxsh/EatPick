...
let yelpAppID = "04af8wEFN44GYMXtYwjrWg"
let yelpAppSecret = "GvsevUK4n1e8FeRmhjMfgdcXXJ2qGE3pJu6fWK2uARam7X0vUJClSDi6PXvvVno1"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        YelpAPI.configure(WithID: yelpAppID,Secret: yelpAppSecret)
        SHLocationManager.configuration()
        return true
    }
